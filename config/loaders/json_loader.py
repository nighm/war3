...
class JsonLoader:
    ...
    def load_from_file(self, file_path: Union[str, Path], validate: bool = True) -> AppConfig:
        ...
        try:
            ...
            # 转换为AppConfig对象
            config = self._convert_to_app_config(json_data)
    ...
    def load_from_string(self, json_string: str, validate: bool = True) -> AppConfig:
        """
        从JSON字符串加载配置
    ...
    def save_to_file(self, config: AppConfig, file_path: Union[str, Path], 
    ...
    def _convert_to_app_config(self, json_data: Dict[str, Any]) -> AppConfig:
        """
        将JSON数据转换为AppConfig对象
        
        Args:
            json_data: JSON解析后的数据
        ...
        # 设置环境标识
        environment = json_data.get('environment', 'development')
        
        # 创建AppConfig对象
        config = AppConfig.from_dict(json_data)
            ...
            "properties": {
                ...
                "war3": {
                    ...
                    "properties": {
                        ...
                        "editor_type": {
                            "type": "string",
                            "enum": ["world_editor", "y3_editor", "jngp", "custom"]
                        }
                    }
                },
                "editor": {
